	...
	public function get_payment_method_form_fields() {
		return array(
			'global_payments_merchant_id' => array(
				...
				'type'              => 'text',
				'description'       => __( 'Your Client ID provided by Global Payments. It is sent to Google Pay as the <code>gatewayMerchantId</code> so tokens are encrypted to your Global Payments account. Find it in your Global Payments account, or ask your Global Payments support contact.', 'globalpayments-gateway-provider-for-woocommerce' ),
				'desc_tip'          => false,
			...
			'google_merchant_id'          => array(
				...
				'type'        => 'text',
				'description' => __( 'Your Google Pay Merchant ID, issued once your integration is approved in the <a href="https://pay.google.com/business/console" target="_blank" rel="noopener noreferrer">Google Pay &amp; Wallet Console</a>. Required for the live (production) environment; it can be left blank while testing.', 'globalpayments-gateway-provider-for-woocommerce' ),
				'desc_tip'    => false,
			),
			'google_merchant_name'        => array(
				'title'       => __( 'Google Merchant Display Name', 'globalpayments-gateway-provider-for-woocommerce' ),
				'type'        => 'text',
				'description' => __( 'The store name shown to the customer in the Google Pay dialog.', 'globalpayments-gateway-provider-for-woocommerce' ),
				'desc_tip'    => false,
			),
			'cc_types'                    => array(
				...
				'description' => __( 'The card networks offered to the customer in the Google Pay sheet.', 'globalpayments-gateway-provider-for-woocommerce' ),
				'desc_tip'    => false,
				'options' => array(
